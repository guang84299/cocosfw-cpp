...
#ifndef GDeviceInfoAndroid_h
#define GDeviceInfoAndroid_h

#include "tools/GDeviceInfo.h"

class GDeviceInfoAndroid : public GDeviceInfo
{
public:
    static GDeviceInfoAndroid* getInstance();
