...
def main():
    ...
    project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'libguang'))
    cocos_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'cocos2d-x'))
    jsb_root = os.path.abspath(os.path.join(project_root, 'js-bindings'))
    cxx_generator_root = os.path.abspath(os.path.join(os.path.dirname(__file__), 'bindings-generator'))
    ...
    try:
        ...
        tojs_root = '%s/../script-tools' % project_root
        output_dir = '%s/js-bindings/auto' % project_root

        cmd_args = {'libguang.ini' : ('libguang', 'jsb_libguang_auto'), }
        target = 'spidermonkey'
